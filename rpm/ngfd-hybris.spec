...
Summary:    Non-graphic feedback service for sounds and other events (hybris variant)
Version:    0.63
Release:    1
...
%package plugin-hybris-vibrator
Summary:    Droid Vibrator HAL plugin for ngfd
Group:      System/Libraries
Requires:   %{name} = %{version}-%{release}

%description plugin-hybris-vibrator
...
%files plugin-hybris-vibrator
%defattr(-,root,root,-)
%{_libdir}/ngf/libngfd_hybris-vibrator.so
